...
taskDB = mdb.mongoDb(url, "taskDB")

def getCollection(collection, query):
	riskCollection = taskDB.queryCollection(collection, query)
	print(riskCollection)
	data = dumps(riskCollection, json_options=CANONICAL_JSON_OPTIONS)
